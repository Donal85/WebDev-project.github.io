...
function navigateToPage() {
  ...
  if (selectedValue.startsWith("#")) {
    ...
    var modal = new bootstrap.Modal(
      document.getElementById("custom_modal_index")
    );
    modal.show();
  } else {
...
function startGame() {
  ...
  document.getElementById("result").innerHTML =
    "I have randomly selected a number between 1-10<br>you have 3 attempts to guess it!";
  ...
  if (userGuess >= 1 && userGuess <= 10) {
    ...
    if (attemptsLeft > 0) {
      ...
      if (userGuess === randomNumber) {
        document.getElementById("result").innerHTML =
          "SUCCESS! <br>" + randomNumber + " is the correct number!";
        endGame();
      } else {
      ...
      if (attemptsLeft == 0 && userGuess !== randomNumber) {
        document.getElementById("result").innerHTML =
          "Oh no! You're out of luck!<br>The correct number was: " +
          randomNumber;
        endGame();
      }
    }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (event) {
    ...
    if (address.value.length < 6) {
      //Check if the length of the address is lass than 6
    ...
    */
    ...
    if (!terms.checked) {
      //Check if the cjeckbox is selected and revert the boolean value using !
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var termsAndConditionsLink = document.getElementById(
